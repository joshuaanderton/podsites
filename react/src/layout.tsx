  ...
  return (
    <aside className={clsx(className, 'bg-neutral-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:items-start lg:overflow-y-auto')}>
      <div className={clsx(
        ...
        <section>
          <Link to="/" aria-label="Homepage" className="relative mx-auto block w-48 rounded-lg overflow-hidden bg-neutral-100 shadow-xl shadow-neutral-100 sm:w-64 lg:w-auto">
